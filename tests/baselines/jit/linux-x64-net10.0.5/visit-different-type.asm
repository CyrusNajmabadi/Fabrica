...
G_M000_IG02:                ;; offset=0x0001
       call     [Fabrica.Core.Memory.RefCountTable`1+DecrementNodeRefCountVisitor`1[TreeNode,TreeHandler]:Visit[OtherNode](Fabrica.Core.Memory.Handle`1[OtherNode]):this]
       nop      
