...
public class CrossTypeSnapshotTests
{
    ...
    public void CrossType_ReleasingParent_FreesChildWhenUnreferenced()
    {
        ...
        var parentRoots = NonCopyableUnsafeList<Handle<ParentNode>>.Create();
        ...
        parentStore.ReleaseSnapshotSlice(parentSlice);
    ...
    public void CrossType_ChildAlsoHasDirectRoot_SurvivesParentRelease()
    {
        ...
        var childRoots = NonCopyableUnsafeList<Handle<ChildNode>>.Create();
        ...
        childStore.ReleaseSnapshotSlice(childSlice);
        ...
        int third)
    {
        ...
        var parentRootHandles = new Handle<ParentNode>[3];
        ...
        for (var i = 0; i < 3; i++)
        {
            ...
            parentRootHandles[i] = AllocParent(
                parentStore,
                childStore,
                Handle<ParentNode>.None,
                Handle<ParentNode>.None,
            ...
            var parentList = NonCopyableUnsafeList<Handle<ParentNode>>.Create();
            ...
            var childList = NonCopyableUnsafeList<Handle<ChildNode>>.Create();
        ...
        for (var step = 0; step < 3; step++)
        {
            ...
            parentStore.ReleaseSnapshotSlice(parentSlices[snapshotIndex]);
            childStore.ReleaseSnapshotSlice(childSlices[snapshotIndex]);

            Assert.Equal(0, parentStore.RefCounts.GetCount(parentRootHandles[snapshotIndex]));
