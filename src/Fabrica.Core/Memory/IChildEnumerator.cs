...
/// <see cref="Handle{T}"/> to an <see cref="IChildAction"/> callback. Implementations encode
/// the structure of a specific node type — which fields are child handles. The action is
/// pluggable: increment, validate, collect, etc.
///
