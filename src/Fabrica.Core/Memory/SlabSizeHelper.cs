...
/// <summary>
/// Computes the optimal slab array length for a given element type. Mirrors Roslyn's <c>SegmentedArrayHelper</c>: finds
/// the largest power-of-2 element count whose backing array stays below the LOH threshold (~85,000 bytes). Power-of-2
/// sizing enables bit-shift division and bitwise-AND modulo for O(1) position-to-offset mapping.
/// </summary>
internal static class SlabSizeHelper<T>
{
